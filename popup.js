    ...
    (tabs) => {
      chrome.tabs.sendMessage(
        ...
        (paymentInfo) => {
          warner.innerText = ''
          if (
            paymentInfo.originalPrice < 25 ||
            paymentInfo.originalPrice < paymentInfo.priceLimit
          ) {
            result.style.color = "#df4578"
            warner.innerText =
              `Price should be higher than ${paymentInfo.priceLimit}$`
          }
